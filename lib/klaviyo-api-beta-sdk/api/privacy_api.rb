  ...
  class PrivacyApi
    ...
    def create_data_privacy_deletion_job_with_http_info(data_privacy_create_deletion_job_query, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PrivacyApi.create_data_privacy_deletion_job ...'
      end
      ...
      if @api_client.config.client_side_validation && data_privacy_create_deletion_job_query.nil?
        fail ArgumentError, "Missing the required parameter 'data_privacy_create_deletion_job_query' when calling PrivacyApi.create_data_privacy_deletion_job"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PrivacyApi.create_data_privacy_deletion_job",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PrivacyApi#create_data_privacy_deletion_job\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
