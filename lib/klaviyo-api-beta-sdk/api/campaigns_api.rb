...
module KlaviyoBetaAPI
  class CampaignsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Hash<String, Object>]
    def create_campaign_create_clone(campaign_clone_query, opts = {})
      data, _status_code, _headers = create_campaign_create_clone_with_http_info(campaign_clone_query, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Hash<String, Object>, Integer, Hash)>] Hash<String, Object> data, response status code and response headers
    def create_campaign_create_clone_with_http_info(campaign_clone_query, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CampaignsApi.create_campaign_create_clone ...'
      end
      ...
      if @api_client.config.client_side_validation && campaign_clone_query.nil?
        fail ArgumentError, "Missing the required parameter 'campaign_clone_query' when calling CampaignsApi.create_campaign_create_clone"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CampaignsApi.create_campaign_create_clone",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CampaignsApi#create_campaign_create_clone\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
